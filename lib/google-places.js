...
GooglePlaces.prototype._process = function(cachePath, query, method, cb) {
  ...
  this._cache.get(cachePath, function(err, data) {
    ...
    return that._doRequest(query, method, function(err, data) {
      ...
      // Borramos resultados duplicados del autocomplete NOTE: Esto tiene que mejorarse, pero por ahora nos evitamos problemas @pballester
      if (method === 'autocomplete') {
        dataObject.predictions = _.uniqBy(dataObject.predictions, 'description');
      }
