...
a.autocomplete({input: 'Vale'}, function(err, response){
  console.timeEnd('autocomplete1');
});
a.details({reference: 'CjQnAAAAyIh5GJD8eN_XcPzitEAzn-74YxVOQBKMpFnwkXyXCw2F7U2CbReskNeFmQ74bKVWEhDH7OqEhhKB6crEQzXu7Ns1GhSyojkV5BhiZ5upEOUB-sf8VDl2lw'}, function(err, response){
